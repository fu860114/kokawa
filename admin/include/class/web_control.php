<?php
	...
	class web_control{
		...
		function ListPage($_url,$_tag){
			...
			elseif($this->shopconfig[$this->block] == "MONTH_BEST") // **
				return $this->ListPage_MONTH_BEST($_url,$_tag);
			...
			elseif($this->shopconfig[$this->block] == "BEST_PROD")
				return $this->ListPage_BEST_PROD($_url,$_tag);
		...
		function EditPage($_url,$_tag){
			...
			elseif($this->shopconfig[$this->block] == "MONTH_BEST")
				return $this->EditPage_MONTH_BEST($_url,$_tag);
			elseif($this->shopconfig[$this->block] == "BEAUTY_SHOW")
			...
			elseif($this->shopconfig[$this->block] == "BEST_PROD")
				return $this->EditPage_BEST_PROD($_url,$_tag);
		...
		function CreateHtml($_date){
			...
			elseif($this->shopconfig[$this->block] == "MONTH_BEST")
				$this->CreateHtml_MONTH_BEST($_date);
			elseif($this->shopconfig[$this->block] == "BEAUTY_SHOW")
			...
			elseif($this->shopconfig[$this->block] == "BEST_PROD")
				$this->CreateHtml_BEST_PROD($_date);
		...
		function Select_Product($_url,$_field){
			...
			if($this->shopid == 1){
				...
				//列表資料
				$sqlstr = "Select * FROM `".Front_Product."` WHERE `DelFlag` = '' and `to_index` = 'Y' and `status` = '".FProduct_Status_Up."'".$SearchWhereStr;
				$DataNum = $g_db->numRows( $g_db->query( $sqlstr ) );

				//列表資料
				$startuprow = $pageno * $this->pageshownum;
				$sqlstr = "Select * FROM `".Front_Product."` WHERE `DelFlag` = '' and `to_index` = 'Y' and `status` = '".FProduct_Status_Up."'".$SearchWhereStr."ORDER BY `serno` desc Limit ".$startuprow.",".$this->pageshownum."";
				...
				//列表資料
				$sqlstr = "Select * FROM `".Front_Product."` WHERE `DelFlag` = '' and `shopid` = '".$this->shopid."' and `status` = '".FProduct_Status_Up."'".$SearchWhereStr;
				$DataNum = $g_db->numRows( $g_db->query( $sqlstr ) );

				//列表資料
				$startuprow = $pageno * $this->pageshownum;
				$sqlstr = "Select * FROM `".Front_Product."` WHERE `DelFlag` = '' and `shopid` = '".$this->shopid."' and `status` = '".FProduct_Status_Up."'".$SearchWhereStr."ORDER BY `serno` desc Limit ".$startuprow.",".$this->pageshownum."";
				$DataList = $g_db->getAll( $sqlstr );
				...
				//列表資料
				$sqlstr = "Select * FROM `".Front_Product."` WHERE `DelFlag` = '' and `shopid` = '".$NowShopData['shopid']."' and `status` = '".FProduct_Status_Up."'".$SearchWhereStr;
				$DataNum = $g_db->numRows( $g_db->query( $sqlstr ) );

				//列表資料
				$startuprow = $pageno * $this->pageshownum;
				$sqlstr = "Select * FROM `".Front_Product."` WHERE `DelFlag` = '' and `shopid` = '".$NowShopData['shopid']."' and `status` = '".FProduct_Status_Up."'".$SearchWhereStr."ORDER BY `serno` desc Limit ".$startuprow.",".$this->pageshownum."";
				$DataList = $g_db->getAll( $sqlstr );
			...
			for($i = 0; $i < sizeof($DataList); $i++){
				...
				$sqlstr = "SELECT `price`,`supp_price` FROM `".Product_Price."` WHERE `DelFlag` = '' and `pid` = '".$DataList[$i]['prodserno']."' and `start_time` <= '".date("Y-m-d H:i:s")."' and `end_time` > '".date("Y-m-d H:i:s")."' ORDER BY `order_min` desc LIMIT 1";
				$ProdPriceData = $g_db->getRow($sqlstr);
				...
				$ListCotent .=  "          <td align=\"right\">".number_format($ProdPriceData['price'])."</td>\n";
				$ListCotent .=  "          <td align=\"right\">".number_format($ProdPriceData['supp_price'])."</td>\n";
		...
		function EditPage_ACTIVITY($_url,$_tag){
			...
			$EditCotent .=  "          <td align=\"left\"><input name=\"enddate\" type=\"text\" value=\"".($Data != "" ? $Data['enddate'] : date("Y-m-d",mktime(0,0,0,date("m"),date("d"),date("Y")+1))." 00:00:00" )."\" /></td>\n";
			$EditCotent .=  "        </tr>\n";
		...
		function ListPage_MAINSHOW($_url,$_tag){
			...
			//列表資料
			$sqlstr = "Select * FROM `".Top_ShopConfig."` WHERE `DelFlag` = '' and `shopid` = '".$this->shopid."' and `block` = '".$this->block."' and `config` = '' and `tag` = '".$_tag."'";
			$DataNum = $g_db->numRows( $g_db->query( $sqlstr ) );
		
			//列表資料
			$startuprow = $pageno * $this->pageshownum;
			$sqlstr = "Select * FROM `".Top_ShopConfig."` WHERE `DelFlag` = '' and `shopid` = '".$this->shopid."' and `block` = '".$this->block."' and `config` = '' and `tag` = '".$_tag."' ORDER BY `startdate` desc,`serno` desc Limit ".$startuprow.",".$this->pageshownum."";
			$DataList = $g_db->getAll( $sqlstr );
		...
		function EditPage_MAINSHOW($_url,$_tag){
			...
			$EditCotent .=  "          <td align=\"left\"><input type=\"hidden\" name=\"pid1\" id=\"pid1\" value=\"".$Data['pid1']."\"><input name=\"pid1name\" id=\"pid1name\" type=\"text\" value=\"".htmlspecialchars($Data['pid1name'])."\" size=\"50\" ReadOnly /> <input type=\"button\" class=\"gray_btn\" value=\"選擇商品\" onclick=\"sel_prod('pid1');\"></td>\n";
			...
			$EditCotent .=  "          <td align=\"left\"><input type=\"hidden\" name=\"pid2\" id=\"pid2\" value=\"".$Data['pid2']."\"><input name=\"pid2name\" id=\"pid2name\" type=\"text\" value=\"".htmlspecialchars($Data['pid2name'])."\" size=\"50\" ReadOnly /> <input type=\"button\" class=\"gray_btn\" value=\"選擇商品\" onclick=\"sel_prod('pid2');\"></td>\n";
			...
			$EditCotent .=  "          <td align=\"left\"><input type=\"hidden\" name=\"pid3\" id=\"pid3\" value=\"".$Data['pid3']."\"><input name=\"pid3name\" id=\"pid3name\" type=\"text\" value=\"".htmlspecialchars($Data['pid3name'])."\" size=\"50\" ReadOnly /> <input type=\"button\" class=\"gray_btn\" value=\"選擇商品\" onclick=\"sel_prod('pid3');\"></td>\n";
			...
			$EditCotent .=  "          <td align=\"left\"><input type=\"hidden\" name=\"pid4\" id=\"pid4\" value=\"".$Data['pid4']."\"><input name=\"pid4name\" id=\"pid4name\" type=\"text\" value=\"".htmlspecialchars($Data['pid4name'])."\" size=\"50\" ReadOnly /> <input type=\"button\" class=\"gray_btn\" value=\"選擇商品\" onclick=\"sel_prod('pid4');\"></td>\n";
			...
			$EditCotent .=  "          <td align=\"left\"><input type=\"hidden\" name=\"pid5\" id=\"pid5\" value=\"".$Data['pid5']."\"><input name=\"pid5name\" id=\"pid5name\" type=\"text\" value=\"".htmlspecialchars($Data['pid5name'])."\" size=\"50\" ReadOnly /> <input type=\"button\" class=\"gray_btn\" value=\"選擇商品\" onclick=\"sel_prod('pid5');\"></td>\n";
		...
		function CreateHtml_MAINSHOW($_date){
			...
			echo "				<div class=\"product_list_title_text text_16px ".($this->shopid == 1 ? "text_color" : "color_white")." text_style\">".$ConfigData['config_attr1']."</div>\n";
			...
			for($i = 1; $i <= 4; $i++){
				...
				if($$NowData != "" || ($i == 1 && ($Data2 == "" && $Data3 == "" && $Data4 == ""))){
					...
					$sqlstr = "SELECT `price` FROM `".Product_Price."` WHERE `DelFlag` = '' and `pid` = '".$ProdData1['prodserno']."' and `start_time` <= '".$_date."' and `end_time` > '".$_date."' ORDER BY `order_min` desc LIMIT 1";
					$ProdPrice1 = $g_db->getOne($sqlstr);
					$sqlstr = "SELECT `price` FROM `".Product_Price."` WHERE `DelFlag` = '' and `pid` = '".$ProdData2['prodserno']."' and `start_time` <= '".$_date."' and `end_time` > '".$_date."' ORDER BY `order_min` desc LIMIT 1";
					$ProdPrice2 = $g_db->getOne($sqlstr);
					$sqlstr = "SELECT `price` FROM `".Product_Price."` WHERE `DelFlag` = '' and `pid` = '".$ProdData3['prodserno']."' and `start_time` <= '".$_date."' and `end_time` > '".$_date."' ORDER BY `order_min` desc LIMIT 1";
					$ProdPrice3 = $g_db->getOne($sqlstr);
					$sqlstr = "SELECT `price` FROM `".Product_Price."` WHERE `DelFlag` = '' and `pid` = '".$ProdData4['prodserno']."' and `start_time` <= '".$_date."' and `end_time` > '".$_date."' ORDER BY `order_min` desc LIMIT 1";
					$ProdPrice4 = $g_db->getOne($sqlstr);
					$sqlstr = "SELECT `price` FROM `".Product_Price."` WHERE `DelFlag` = '' and `pid` = '".$ProdData5['prodserno']."' and `start_time` <= '".$_date."' and `end_time` > '".$_date."' ORDER BY `order_min` desc LIMIT 1";
					$ProdPrice5 = $g_db->getOne($sqlstr);
					...
					if( ${$NowData}['pid1'] ){
						...
						echo "							<a href=\"".(${$NowData}['url'] != '' ? ${$NowData}['url'] : "product_info.php?id=".${$NowData}['pid1'])."\"><img src=\"".($ProdData1['prod_pic'] != "" ? "product_pic.php?id=".${$NowData}['pid1'] : Upload_Url."../../web/images/pro_rc_pic01.jpg")."\" width=\"120\" height=\"120\" /></a>\n";
						...
						echo "							$".number_format($ProdPrice1)."元\n";	
					...
					if( ${$NowData}['pid2'] ){
						echo "					<ul class=\"product_list_cont_box\">\n";		
						echo "						<li class=\"product_list_cont_pictitle\">\n";
						echo "							<a href=\"".(${$NowData}['url2'] != '' ? ${$NowData}['url2'] : "product_info.php?id=".${$NowData}['pid2'])."\"><img src=\"".($ProdData2['prod_pic'] != "" ? "product_pic.php?id=".${$NowData}['pid2'] : Upload_Url."../../web/images/pro_rc_pic01.jpg")."\" width=\"120\" height=\"120\" /></a>\n";
						echo "						</li><!--End of product_list_cont_pictitle-->\n";
						...
						echo "						</li><!--End of product_list_cont_info_text-->\n";
						echo "						<li class=\"product_list_cont_price text_14px color_red\">\n";	
						echo "							$".number_format($ProdPrice2)."元\n";	
						echo "						</li><!--End of product_list_cont_price-->\n";
						echo "					</ul>\n";
					}			
					if( ${$NowData}['pid3'] ){
						echo "					<ul class=\"product_list_cont_box\">\n";		
						echo "						<li class=\"product_list_cont_pictitle\">\n";
						echo "							<a href=\"".(${$NowData}['url3'] != '' ? ${$NowData}['url3'] : "product_info.php?id=".${$NowData}['pid3'])."\"><img src=\"".($ProdData3['prod_pic'] != "" ? "product_pic.php?id=".${$NowData}['pid3'] : Upload_Url."../../web/images/pro_rc_pic01.jpg")."\" width=\"120\" height=\"120\" /></a>\n";
						echo "						</li><!--End of product_list_cont_pictitle-->\n";
						...
						echo "						</li><!--End of product_list_cont_info_text-->\n";
						echo "						<li class=\"product_list_cont_price text_14px color_red\">\n";	
						echo "							$".number_format($ProdPrice3)."元\n";	
						echo "						</li><!--End of product_list_cont_price-->\n";
						echo "					</ul>\n";
					}	
					if( ${$NowData}['pid4'] ){
						echo "					<ul class=\"product_list_cont_box\">\n";		
						echo "						<li class=\"product_list_cont_pictitle\">\n";
						echo "							<a href=\"".(${$NowData}['url4'] != '' ? ${$NowData}['url4'] : "product_info.php?id=".${$NowData}['pid4'])."\"><img src=\"".($ProdData4['prod_pic'] != "" ? "product_pic.php?id=".${$NowData}['pid4'] : Upload_Url."../../web/images/pro_rc_pic01.jpg")."\" width=\"120\" height=\"120\" /></a>\n";
						echo "						</li><!--End of product_list_cont_pictitle-->\n";
						...
						echo "						</li><!--End of product_list_cont_info_text-->\n";
						echo "						<li class=\"product_list_cont_price text_14px color_red\">\n";	
						echo "							$".number_format($ProdPrice4)."元\n";	
						echo "						</li><!--End of product_list_cont_price-->\n";
						echo "					</ul>\n";
					}
					if( ${$NowData}['pid5'] ){
						echo "					<ul class=\"product_list_cont_box\">\n";		
						echo "						<li class=\"product_list_cont_pictitle\">\n";
						echo "							<a href=\"".(${$NowData}['url5'] != '' ? ${$NowData}['url5'] : "product_info.php?id=".${$NowData}['pid5'])."\"><img src=\"".($ProdData5['prod_pic'] != "" ? "product_pic.php?id=".${$NowData}['pid5'] : Upload_Url."../../web/images/pro_rc_pic01.jpg")."\" width=\"120\" height=\"120\" /></a>\n";
						echo "						</li><!--End of product_list_cont_pictitle-->\n";
						...
						echo "						</li><!--End of product_list_cont_info_text-->\n";
						echo "						<li class=\"product_list_cont_price text_14px color_red\">\n";	
						echo "							$".number_format($ProdPrice5)."元\n";	
						echo "						</li><!--End of product_list_cont_price-->\n";
						echo "					</ul>\n";
					}
			...
			for($i = 1; $i <= 4; $i++){
				...
				if($$NowData != "" || ($i == 1 && ($Data2 == "" && $Data3 == "" && $Data4 == ""))){
					...
					if( ${$NowData}['pid1'] ){
						...
						echo "						<tr>\n";
						echo "							<td><a href=\"".(${$NowData}['url'] != '' ? ${$NowData}['url'] : "product_info.php?id=".${$NowData}['pid1'])."\"><img src=\"".($ProdData1['prod_pic'] != "" ? "product_pic.php?id=".${$NowData}['pid1'] : Upload_Url."images/autoshow_pro_pic1.png")."\" width=\"115\" height=\"115\" /></a></td>\n";
						echo "						</tr>\n";
						echo "						<tr>\n";
						echo "							<td class=\"text_black_title16px\"><a href=\"".(${$NowData}['url'] != '' ? ${$NowData}['url'] : "product_info.php?id=".${$NowData}['pid1'])."\">".$ProdData1['name']."</a></td>\n";
						echo "						<tr>\n";
						echo "						<tr>\n";
						echo "							<td class=\"text_12px\"><span class=\"color_red text_16px\">$".number_format($ProdPrice1)."元</span></td>\n";
						echo "						<tr>\n";
						echo "					</table>\n";
					}
					if( ${$NowData}['pid2'] ){
						echo "					<table class=\"autoshow_pro_pic_box\" cellspacing=\"0\" cellpadding=\"0\">\n";		
						echo "						<tr>\n";
						echo "							<td><a href=\"".(${$NowData}['url2'] != '' ? ${$NowData}['url2'] : "product_info.php?id=".${$NowData}['pid2'])."\"><img src=\"".($ProdData2['prod_pic'] != "" ? "product_pic.php?id=".${$NowData}['pid2'] : Upload_Url."images/autoshow_pro_pic1.png")."\" width=\"115\" height=\"115\" /></a></td>\n";
						echo "						</tr>\n";
						echo "						<tr>\n";
						echo "							<td class=\"text_black_title16px\"><a href=\"".(${$NowData}['url2'] != '' ? ${$NowData}['url2'] : "product_info.php?id=".${$NowData}['pid2'])."\">".$ProdData2['name']."</a></td>\n";
						echo "						<tr>\n";
						echo "						<tr>\n";
						echo "							<td class=\"text_12px\"><span class=\"color_red text_16px\">$".number_format($ProdPrice2)."元</span></td>\n";
						echo "						<tr>\n";
						echo "					</table>\n";
					}			
					if( ${$NowData}['pid3'] ){
						echo "					<table class=\"autoshow_pro_pic_box\" cellspacing=\"0\" cellpadding=\"0\">\n";		
						echo "						<tr>\n";
						echo "							<td><a href=\"".(${$NowData}['url3'] != '' ? ${$NowData}['url3'] : "product_info.php?id=".${$NowData}['pid3'])."\"><img src=\"".($ProdData3['prod_pic'] != "" ? "product_pic.php?id=".${$NowData}['pid3'] : Upload_Url."images/autoshow_pro_pic1.png")."\" width=\"115\" height=\"115\" /></a></td>\n";
						echo "						</tr>\n";
						echo "						<tr>\n";
						echo "							<td class=\"text_black_title16px\"><a href=\"".(${$NowData}['url3'] != '' ? ${$NowData}['url3'] : "product_info.php?id=".${$NowData}['pid3'])."\">".$ProdData3['name']."</a></td>\n";
						echo "						<tr>\n";
						echo "						<tr>\n";
						echo "							<td class=\"text_12px\"><span class=\"color_red text_16px\">$".number_format($ProdPrice3)."元</span></td>\n";
						echo "						<tr>\n";
						echo "					</table>\n";
					}	
					if( ${$NowData}['pid4'] ){
						echo "					<table class=\"autoshow_pro_pic_box\" cellspacing=\"0\" cellpadding=\"0\">\n";		
						echo "						<tr>\n";
						echo "							<td><a href=\"".(${$NowData}['url4'] != '' ? ${$NowData}['url4'] : "product_info.php?id=".${$NowData}['pid4'])."\"><img src=\"".($ProdData4['prod_pic'] != "" ? "product_pic.php?id=".${$NowData}['pid4'] : Upload_Url."images/autoshow_pro_pic1.png")."\" width=\"115\" height=\"115\" /></a></td>\n";
						echo "						</tr>\n";
						echo "						<tr>\n";
						echo "							<td class=\"text_black_title16px\"><a href=\"".(${$NowData}['url4'] != '' ? ${$NowData}['url4'] : "product_info.php?id=".${$NowData}['pid4'])."\">".$ProdData4['name']."</a></td>\n";
						echo "						<tr>\n";
						echo "						<tr>\n";
						echo "							<td class=\"text_12px\"><span class=\"color_red text_16px\">$".number_format($ProdPrice4)."元</span></td>\n";
						echo "						<tr>\n";
						echo "					</table>\n";
					}
					if($Data.$i != '')
		...
		function ListPage_SUBSHOW($_url,$_tag){
			...
			//列表資料
			$sqlstr = "Select * FROM `".Top_ShopConfig."` WHERE `DelFlag` = '' and `shopid` = '".$this->shopid."' and `block` = '".$this->block."' and `config` = ''";
			$DataNum = $g_db->numRows( $g_db->query( $sqlstr ) );
		
			//列表資料
			$startuprow = $pageno * $this->pageshownum;
			$sqlstr = "Select * FROM `".Top_ShopConfig."` WHERE `DelFlag` = '' and `shopid` = '".$this->shopid."' and `block` = '".$this->block."' and `config` = '' ORDER BY `startdate` desc,`serno` desc Limit ".$startuprow.",".$this->pageshownum."";
			$DataList = $g_db->getAll( $sqlstr );
		...
		function ConfigPage_SUBSHOW($_url){
			...
			$EditCotent .=  "        <tr>\n";
			$EditCotent .=  "          <th scope=\"col\">顏色</th>\n";
			$EditCotent .=  "          <td align=\"left\"><select name=\"config_attr2\"><option value=\"green_prolist_stitle\" ".($Data['config_attr2'] == "green_prolist_stitle" ? "selected" : "").">藍色</option><option value=\"blue_prolist_stitle\" ".($Data['config_attr2'] == "blue_prolist_stitle" ? "selected" : "").">黃色</option><option value=\"pink_prolist_stitle\" ".($Data['config_attr2'] == "pink_prolist_stitle" ? "selected" : "").">粉紅色</option><option value=\"purple_prolist_stitle\" ".($Data['config_attr2'] == "purple_prolist_stitle" ? "selected" : "").">紫色</option></select></td>\n";
			$EditCotent .=  "        </tr>\n";
			$EditCotent .=  "      </table><!--End of table_style-->\n";
			$EditCotent .=  "      </form>\n";
			$EditCotent .=  "      <div class=\"whitebox\">\n";
		...
		function CreateHtml_SUBSHOW($_date){
			...
			echo "				<div class=\"small_prolist_title_txt\">".($this->shopid != 1 ? $Data['name'] : "")."</div>\n";
			//echo "				<div class=\"small_prolist_more\"></div>\n";
			echo "			</div>\n";
			...
			if($ProdData1 && sizeof($ProdData1)>0){
				echo "				<li class=\"pro1\">\n";
				echo "					<ul>\n";
				echo "						<li><a class=\"propic_style\" href=\"".($Data['url'] != '' ? $Data['url'] : "product_info.php?id=".$Data['pid1'])."\" target=\"".$Data['target1']."\"><img src=\"".($ProdData1['prod_pic'] != "" ? "product_pic.php?id=".$Data['pid1'] : Upload_Url."../../web/images/pro_pic02.jpg")."\" width=\"130\" height=\"130\" /></a></li>\n";
				echo "						<li><a class=\"pro_info_txt\" href=\"".($Data['url'] != '' ? $Data['url'] : "product_info.php?id=".$Data['pid1'])."\" target=\"".$Data['target1']."\"><span class=\"pro_info_title\">\n";
					if(mb_strlen($ProdData1['name'] , 'utf-8') > 15) {echo mb_substr($ProdData1['name'] ,0,15,'UTF-8')."...";}else{echo $ProdData1['name'];}
				echo "</span><br />".$Data['slogan1']."</a></li>\n";
				echo "						<li>\n";
				echo "							<span class=\"pro_info_price\"><span class=\"pro_info_money\">$".number_format($ProdPrice1)."</span>元</span>\n";
				echo "						</li>\n";
				echo "					</ul>\n";
				echo "				</li>\n";
			}
			if($ProdData2 && sizeof($ProdData2)>0){
				...
				echo "						<tr>\n";
				echo "							<th rowspan=\"2\"><a class=\"spropic_style\" href=\"".($Data['url2'] != '' ? $Data['url2'] : "product_info.php?id=".$Data['pid2'])."\" target=\"".$Data['target2']."\"><img src=\"".($ProdData2['prod_pic'] != "" ? "product_pic.php?id=".$Data['pid2'] : Upload_Url."../../web/images/pro_pic02.jpg")."\" width=\"90\" height=\"90\" /></a></th>\n";
				echo "							<td><a class=\"pro_info_txt\" href=\"".($Data['url2'] != '' ? $Data['url2'] : "product_info.php?id=".$Data['pid2'])."\" target=\"".$Data['target2']."\"><span class=\"pro_info_title\">\n";
					if(mb_strlen($ProdData2['name'] , 'utf-8') > 15) {echo mb_substr($ProdData2['name'] ,0,15,'UTF-8')."...";}else{echo $ProdData2['name'];}
				echo "					</span><br />".$Data['slogan2']."</a><br /><span class=\"pro_info_money\">$".number_format($ProdPrice2)."</span>元</td>\n";
				echo "						</tr>\n";
				echo "						<tr>\n";
				echo "							<td align=\"right\" class=\"pro_info_cart\"></td>\n";
				echo "						</tr>\n";
				echo "					</table>\n";
				echo "				</li>\n";
			}
			if($ProdData3 && sizeof($ProdData3)>0){
				...
				echo "					<table cellspacing=\"0\">\n";
				echo "						<tr>\n";
				echo "							<th rowspan=\"2\"><a class=\"spropic_style\" href=\"".($Data['url3'] != '' ? $Data['url3'] : "product_info.php?id=".$Data['pid3'])."\" target=\"".$Data['target3']."\"><img src=\"".($ProdData3['prod_pic'] != "" ? "product_pic.php?id=".$Data['pid3'] : Upload_Url."../../web/images/pro_pic01.jpg")."\" width=\"90\" height=\"90\" /></a></th>\n";
				echo "							<td><a class=\"pro_info_txt\" href=\"".($Data['url3'] != '' ? $Data['url3'] : "product_info.php?id=".$Data['pid3'])."\" target=\"".$Data['target3']."\"><span class=\"pro_info_title\">\n";
					if(mb_strlen($ProdData3['name'] , 'utf-8') > 15) {echo mb_substr($ProdData3['name'] ,0,15,'UTF-8')."...";}else{echo $ProdData3['name'];}
				echo "			</span><br />".$Data['slogan3']."</a><br /><span class=\"pro_info_money\">$".number_format($ProdPrice3)."</span>元</td>\n";
				echo "						</tr>\n";
				echo "						<tr>\n";
				echo "							<td align=\"right\" class=\"pro_info_cart\"></td>\n";
				echo "						</tr>\n";
			...
			echo "				</ul>\n";
			echo "			</div>\n";
			echo "			<div><img src=\"images/small_prolist_bg_bottom.png\" width=\"387\" height=\"4\" /></div>\n";
			}
		...
		function CreateHtml_HOTSALE1($_date){
			...
			echo "                </tr>";
			echo "                <tr>";
			echo "                  <td align='right' class='banner_01_cont'>$<a href=\"".($Data['url']!=""?$Data['url']:"#")."\" target=\"".$Data['target']."\"><strong class='price_num'>".number_format($ProdData1['price'])."</strong></a>元</td>";
			echo "                </tr>";
			echo "              </table>";
			echo "            </li>";
			echo "            <li class='banner_01_info'>";
			...
			echo "                </tr>";
			echo "                <tr>";
			echo "                  <td align='right' class='banner_01_cont'>$<a href=\"".($Data['url2']!=""?$Data['url2']:"#")."\" target=\"".$Data['target2']."\"><strong class='price_num'>".number_format($ProdData2['price'])."</strong></a>元</td>";
			echo "                </tr>";
			echo "              </table>";
			echo "            </li>";
			echo "            <li class='banner_01_info'>";
			...
			echo "                </tr>";
			echo "                <tr>";
			echo "                  <td align='right' class='banner_01_cont'>$<a href=\"".($Data['url3']!=""?$Data['url3']:"#")."\" target=\"".$Data['target3']."\"><strong class='price_num'>".number_format($ProdData3['price'])."</strong></a>元</td>";
			echo "                </tr>";
			echo "              </table>";
			echo "            </li>";
		...
		function CreateHtml_HOTSALE2($_date){
			...
			//	echo "				</li><!--End of sec_hot_discount-->\n";
				echo "				<li class=\"sec_hot_pic\"><a href=\"".$Data['url']."\"><img src=\"".Upload_Url.($Data['pic1'] != '' ? $Data['pic1'] : 'default/150X150.jpg')."\" width=\"147\" height=\"147\" /></a></li>\n";
				echo "				<li class=\"sec_hot_txt\">\n";
				echo "					<a href=\"".$Data['url']."\"><p class=\"text_black_title16px\">".$ProdData['name']."</p>\n";
				echo "					<p class=\"text_12px color_gray\">".$Data['slogan1']."</p></a>\n";
				echo "				</li><!--End of sec_hot_pic-->\n";
				echo "				<li class=\"sec_hot_price\">";
				echo "					<div class=\"price_box\">";
				echo "						<p class=\"text_12px price_info\"><span class=\"color_red text_16px\">".number_format($ProdData['price'])."</span>元</p>";
				echo "					</div>";
		...
		function CreateHtml_ADVERTISING($_date){
			...
			if($Data != ""){
				...
				echo "			<a href=\"".($Data['url'] != "" ? $Data['url'] : "#")."\" target=\"".$Data['target']."\"><img " . ( $Data['slogan1'] ? 'alt="' . $Data['slogan1'] . '" title="' . $Data['slogan1'] . '" ' : '' ) . "src=\"".Upload_Url.($Data['pic1'])."\" width=\"1000\" height=\"280\" /></a>";
				echo "		</div>\n";
		...
		function EditPage_POP($_url,$_tag){
			...
			$EditCotent .=  "          <td align=\"left\"><input type=\"hidden\" name=\"pid1\" id=\"pid1\" value=\"".$Data['pid1']."\"><input name=\"pid1name\" id=\"pid1name\" type=\"text\" value=\"".htmlspecialchars($Data['pid1name'])."\" size=\"60\" ReadOnly /> <input type=\"button\" class=\"gray_btn\" value=\"選擇商品\" onclick=\"sel_prod('pid1');\"></td>\n";
			...
			$EditCotent .=  "        <tr>\n";
			$EditCotent .=  "          <th scope=\"col\">商品</th>\n";
			$EditCotent .=  "          <td align=\"left\"><input type=\"hidden\" name=\"pid2\" id=\"pid2\" value=\"".$Data['pid2']."\"><input name=\"pid2name\" id=\"pid2name\" type=\"text\" value=\"".htmlspecialchars($Data['pid2name'])."\" size=\"60\" ReadOnly /> <input type=\"button\" class=\"gray_btn\" value=\"選擇商品\" onclick=\"sel_prod('pid2');\"></td>\n";
			...
			$EditCotent .=  "        <tr>\n";
			$EditCotent .=  "          <th scope=\"col\">商品</th>\n";
			$EditCotent .=  "          <td align=\"left\"><input type=\"hidden\" name=\"pid3\" id=\"pid3\" value=\"".$Data['pid3']."\"><input name=\"pid3name\" id=\"pid3name\" type=\"text\" value=\"".htmlspecialchars($Data['pid3name'])."\" size=\"60\" ReadOnly /> <input type=\"button\" class=\"gray_btn\" value=\"選擇商品\" onclick=\"sel_prod('pid3');\"></td>\n";
			...
			$EditCotent .=  "        <tr>\n";
			$EditCotent .=  "          <th scope=\"col\">商品</th>\n";
			$EditCotent .=  "          <td align=\"left\"><input type=\"hidden\" name=\"pid4\" id=\"pid4\" value=\"".$Data['pid4']."\"><input name=\"pid4name\" id=\"pid4name\" type=\"text\" value=\"".htmlspecialchars($Data['pid4name'])."\" size=\"60\" ReadOnly /> <input type=\"button\" class=\"gray_btn\" value=\"選擇商品\" onclick=\"sel_prod('pid4');\"></td>\n";
			...
			$EditCotent .=  "        <tr>\n";
			$EditCotent .=  "          <th scope=\"col\">商品</th>\n";
			$EditCotent .=  "          <td align=\"left\"><input type=\"hidden\" name=\"pid5\" id=\"pid5\" value=\"".$Data['pid5']."\"><input name=\"pid5name\" id=\"pid5name\" type=\"text\" value=\"".htmlspecialchars($Data['pid5name'])."\" size=\"60\" ReadOnly /> <input type=\"button\" class=\"gray_btn\" value=\"選擇商品\" onclick=\"sel_prod('pid5');\"></td>\n";
		...
		function CreateHtml_POP($_date){
			...
			if($Data != "" ){
				for($i = 1; $i <= 5; $i++){
					...
					$sqlstr = "SELECT `price` FROM `".Product_Price."` WHERE `DelFlag` = '' and `pid` = '".$ProdData['prodserno']."' and `start_time` <= '".$_date."' and `end_time` > '".$_date."' ORDER BY `order_min` desc LIMIT 1";
					$ProdPrice = $g_db->getOne($sqlstr);
					...
					echo "						<div class=\"sec_best_orig_pic\"><img src=\"images/best_num0".$i.".png\" width=\"70\" height=\"30\" /></div>\n";
					echo "					</td><!--End of sec_best_orig_pic_box-->\n";
					echo "					<td class=\"sec_best_orig_txt text_black_title14px\">\n";
											if(mb_strlen($ProdData['name'] , 'utf-8') > 15) {echo mb_substr($ProdData['name'] ,0,15,'UTF-8')."...";}else{echo $ProdData['name'];}
					echo "					</td>\n";
					echo "				</tr>\n";
					echo "				<tr>\n";
					echo "					<td class=\"sec_best_orig_price text_12px\"><span class=\"text_14px color_red\">".number_format($ProdPrice)."</span> 元</td>\n";
					echo "				</tr>\n";
					echo "			</table>\n";
					...
					echo "						<div class=\"sec_best_hover_pic\"><a href=\"".($Data['url'.$i] != '' ? $Data['url'.$i] : "product_info.php?id=".$Data['pid'.$i])."\"><img src=\"product_pic.php?id=".$Data['pid'.$i]."\" width=\"63\" height=\"63\" /></a></div>\n";
					echo "					</td><!--End of sec_best_orig_pic_box-->\n";
					...
					echo "				</tr>\n";
					echo "				<tr>\n";
					echo "					<td class=\"sec_best_hover_txt color_white text_12px\"><span class=\"text_14px color_white\">".number_format($ProdPrice)."</span> 元</td>\n";
					echo "				</tr>\n";
					echo "			</table>\n";
		...
		function ListPage_MONTH_BEST($_url,$_tag){
		...
		function EditPage_MONTH_BEST($_url,$_tag){
		...
		function CreateHtml_MONTH_BEST($_date){
			...
			if(sizeof($DataList) > 0){
				...
				for($i = 0; $i < sizeof($DataList); $i++){
					...
					echo "					<a href=\"product_info.php?id=".$DataList[$i]['pid1']."\"><img src=\"product_pic.php?id=".$DataList[$i]['pid1']."\" width=\"120\" height=\"120\" /></a>\n";
				...
				//	echo "					</div>\n";
					...
					echo "					$".number_format($ProdPrice)."元\n";
...
*/
		...
		function ListPage_BEST_PROD($_url,$_tag){
		...
		function EditPage_BEST_PROD($_url,$_tag){
			...
			$EditCotent .=  "          <td align=\"left\">".($Data['pic2'] != "" ? "<a href=\"".Upload_Url.$Data['pic2']."\" target=\"_blank\"><img " . ( $Data['slogan2'] ? 'alt="' . $Data['slogan2'] . '" title="' . $Data['slogan2'] . '" ' : '' ) . "src=\"".Upload_Url.$Data['pic2']."\" width=\"173\" height=\"78\"></a><br>" : "")."<input name=\"pic2\" type=\"file\" size=\"20\" />".($Data['pic2'] != "" ? " <input type=\"checkbox\" name=\"del_pic2\" value=\"Y\">刪除圖片" : "")."<br><span style=\"color: rgb(255, 0, 0);\">圖片尺寸為 173 × 78 模式為RGB 請避免使用CMYK 解析度為72dpi</span></td>\n";
			$EditCotent .=  "        </tr>\n";
			$EditCotent .=  "        <tr>\n";
			$EditCotent .=  "          <th scope=\"col\">網址2</th>\n";
			...
			$EditCotent .=  "          <td align=\"left\">".($Data['pic3'] != "" ? "<a href=\"".Upload_Url.$Data['pic3']."\" target=\"_blank\"><img " . ( $Data['slogan3'] ? 'alt="' . $Data['slogan3'] . '" title="' . $Data['slogan3'] . '" ' : '' ) . "src=\"".Upload_Url.$Data['pic3']."\" width=\"173\" height=\"78\"></a><br>" : "")."<input name=\"pic3\" type=\"file\" size=\"20\" />".($Data['pic3'] != "" ? " <input type=\"checkbox\" name=\"del_pic3\" value=\"Y\">刪除圖片" : "")."<br><span style=\"color: rgb(255, 0, 0);\">圖片尺寸為 173 × 78 模式為RGB 請避免使用CMYK 解析度為72dpi</span></td>\n";
			$EditCotent .=  "        </tr>\n";
			$EditCotent .=  "        <tr>\n";
			$EditCotent .=  "          <th scope=\"col\">網址3</th>\n";
			$EditCotent .=  "          <td align=\"left\"><input name=\"'url3'\" type=\"text\" value=\"".$Data['url3']."\" size=\"50\" /> 開啟方式：<select name=\"target3\"><option value=\"_self\" ".($Data['target3'] == "_self" ? "selected" : "").">本頁開啟</option><option value=\"_blank\" ".($Data['target3'] == "_blank" ? "selected" : "").">開新視窗</option></select></td>\n";
		...
		function CreateHtml_BEST_PROD($_date){
			...
			if($Data != "" ){
				...
				echo "		<p><a href=\"".($Data['url'] != "" ? $Data['url'] : "#")."\" target=\"".$Data['target']."\" title=\"".$Data['slogan1']."\"><img src=\"".Upload_Url.($Data['pic1'] != '' ? $Data['pic1'] : 'default/175X140.jpg')."\" width=\"173\" height=\"138\" /></a></p>\n";
				echo "		<p><a href=\"".($Data['url2'] != "" ? $Data['url2'] : "#")."\" target=\"".$Data['target2']."\" title=\"".$Data['slogan2']."\"><img src=\"".Upload_Url.($Data['pic2'] != '' ? $Data['pic2'] : 'default/175X80.jpg')."\" width=\"173\" height=\"78\" /></a></p>\n";
				echo "		<p><a href=\"".($Data['url3'] != "" ? $Data['url3'] : "#")."\" target=\"".$Data['target3']."\" title=\"".$Data['slogan3']."\"><img src=\"".Upload_Url.($Data['pic3'] != '' ? $Data['pic3'] : 'default/175X80.jpg')."\" width=\"173\" height=\"78\" /></a></p>\n";
		...
		function CreateHtml_BANNER($_date){
			...
			$Data4 = $g_db->getRow( $sqlstr );
	 		...
	 		echo "				<li><a href=\"".$Data1['url']."\"><img src=\"".Upload_Url.($Data1['pic1'] != '' ? $Data1['pic1'] : 'default/615X280.jpg')."\" width=\"615\" height=\"280\" /></a></li>\n";
	 		echo "				<li><a href=\"".$Data2['url']."\"><img src=\"".Upload_Url.($Data2['pic1'] != '' ? $Data2['pic1'] : 'default/615X280.jpg')."\" width=\"615\" height=\"280\" /></a></li>\n";
	 		echo "				<li><a href=\"".$Data3['url']."\"><img src=\"".Upload_Url.($Data3['pic1'] != '' ? $Data3['pic1'] : 'default/615X280.jpg')."\" width=\"615\" height=\"280\" /></a></li>\n";
	 		echo "				<li><a href=\"".$Data4['url']."\"><img src=\"".Upload_Url.($Data4['pic1'] != '' ? $Data4['pic1'] : 'default/615X280.jpg')."\" width=\"615\" height=\"280\" /></a></li>\n";
		...
		function EditPage_FUN_SHOW($_url,$_tag){
			...
			$EditCotent .=  "        <tr>\n";
			$EditCotent .=  "          <th scope=\"col\">商品1</th>\n";
			$EditCotent .=  "          <td align=\"left\"><input type=\"hidden\" name=\"pid1\" id=\"pid1\" value=\"".$Data['pid1']."\"><input name=\"pid1name\" id=\"pid1name\" type=\"text\" value=\"".htmlspecialchars($Data['pid1name'])."\" size=\"50\" ReadOnly /></td>\n";
			//$EditCotent .=  "          <td align=\"left\"><input type=\"hidden\" name=\"pid1\" id=\"pid1\" value=\"".$Data['pid1']."\"><input name=\"pid1name\" id=\"pid1name\" type=\"text\" value=\"".htmlspecialchars($Data['pid1name'])."\" size=\"50\" ReadOnly /> <input type=\"button\" class=\"gray_btn\" value=\"選擇商品\" onclick=\"sel_prod('pid1');\"> <input type=\"button\" class=\"green_btn\" value=\"預覽商品\" onclick=\"if(($('#pid1').val()) > 0){window.open('display/prodinfo/pro_info.php?fpid='+($('#pid1').val()),'_blank','')}\"></td>\n";
			$EditCotent .=  "        </tr>\n";
			$EditCotent .=  "        <tr>\n";
			$EditCotent .=  "          <th scope=\"col\">網址</th>\n";
			...
			if(sizeof($DataList) < 1){
				...
				for($i = 0; $i < sizeof($DataList); $i++){
					...
					$ProdData = $g_db->getRow($sqlstr);
		 			...
		 			echo "                        </tr>\n";
		 			echo "                        <tr>\n";
		 			echo "                          <td class=\"pro_slide_show_price\">$<strong class=\"price_num_16px\"><a href=\"".($DataList[$i]['url']!=""?$DataList[$i]['url']:"#")."\" target=\"".$DataList[$i]['target']."\">".number_format($ProdData['price'])."</a></strong><span class=\"slogan_buynow\"><a href=\"".($DataList[$i]['url']!=""?$DataList[$i]['url']:"#")."\" target=\"".$DataList[$i]['target']."\">搶購</a></span></td>\n";
		 			echo "                        </tr>\n";
		 			echo "                      </table>\n";
		 			echo "                    </li>\n";
		...
		function CreateHtml_FUN_SHOW2($_date){
			...
			for($i = 1; $i <= 5; $i++){
				...
				$ProdData3 = $g_db->getRow($sqlstr);
	 			...
	 			echo "                            <p class=\"slide_5_pro_price\">$<strong class=\"price_num\"><a href=\"".(${$NowData}['url4']!=""?${$NowData}['url4']:"#")."\" target=\"".${$NowData}['target4']."\">".number_format($ProdData1['price'])."</a></strong><span class=\"slogan_buynow\"><a href=\"".(${$NowData}['url4']!=""?${$NowData}['url4']:"#")."\" target=\"".${$NowData}['target4']."\">搶購</a></span></p>\n";
	 			echo "                          </td>\n";
	 			echo "                        </tr>\n";
	 			echo "                      </table>\n";
	 			echo "                    </td>\n";
	 			...
	 			echo "                            <p class=\"slide_5_pro_price\">$<strong class=\"price_num\"><a href=\"".(${$NowData}['url5']!=""?${$NowData}['url5']:"#")."\" target=\"".${$NowData}['target5']."\">".number_format($ProdData2['price'])."</a></strong><span class=\"slogan_buynow\"><a href=\"".(${$NowData}['url5']!=""?${$NowData}['url5']:"#")."\" target=\"".${$NowData}['target5']."\">搶購</a></span></p>\n";
	 			echo "                          </td>\n";
	 			echo "                        </tr>\n";
	 			echo "                      </table>\n";
	 			echo "                    </td>\n";
	 			...
	 			echo "                            <p class=\"slide_5_pro_price\">$<strong class=\"price_num\"><a href=\"".(${$NowData}['url6']!=""?${$NowData}['url6']:"#")."\" target=\"".${$NowData}['target6']."\">".number_format($ProdData3['price'])."</a></strong><span class=\"slogan_buynow\"><a href=\"".(${$NowData}['url6']!=""?${$NowData}['url6']:"#")."\" target=\"".${$NowData}['target6']."\">搶購</a></span></p>\n";
	 			echo "                          </td>\n";
	 			echo "                        </tr>\n";
	 			echo "                      </table>\n";
	 			echo "                    </td>\n";
      ...
      $targetS = ($Data['target']=='_self' || $Data['target']=='')?"checked":"";
		...
		function CreateHtml_INDEX_CLASS($_date){
			...
			$ShopsID    = array(2,3,4,5,6,7);  //可選擇的館
			$ShopsUrl   = array("shop2","shop3","shop4","shop5","shop6","shop7");  //館的連結
			...
			if( sizeof($MainClass) > 0 ){
				...
				echo "		<div class=\"sec_pro_title\"><img src=\"images/sec_pro_title.png\" width=\"200\" height=\"40\" /></div>\n";
				...
				for($i = 0; $i < sizeof($MainClass); $i++){
					...
					echo "				<div class=\"sec_son_title\"><p>".$MainClass[$i]['shopname']."</p><div class=\"sec_son_down\"></div></div>\n";
					
					echo "				<ul	class=\"sec_son_cont\">\n";
					echo "					<img src=\"images/sec_son_cont_bgtop.png\" width=\"198\" height=\"6\" />\n";

					$sqlstr = "SELECT * FROM `".Web_Shop."` WHERE `DelFlag` = '' and `shopid` = '".$ShopsID[$i]."' and `parentid` = '0' ORDER BY `order`,`serno`";
					...
					for($j = 0; $j < sizeof($SubClass); $j++){
							echo "				<p><a href=\"".$ShopsUrl[$i]."/product_list.php?sid=".$SubClass[$j]['serno']."\">‧".$SubClass[$j]['shopname']."</a></p>\n";
					}
					
					if(sizeof($SubClass) > 0){
						echo "				</li><!--End of sec_pro_left_cont--> \n";
						echo "				<img src=\"images/sec_son_cont_bgbtm.png\" width=\"200\" height=\"5\" /> \n";
					}
				...
				for($i = 0; $i < sizeof($MainClass); $i++){
					...
					for($j = 0; $j < sizeof($SubClass); $j++){
						...
						if($SubClass[$j]['serno'] == $this->shopid){
							...
							$ClassPos = $i;
							echo "				<p><a href=\"product_list.php?sid=".$SubClass[$j]['serno']."\"><span class=\"sec_pro_here\"> ‧ ".$SubClass[$j]['shopname']."</span></a></p>\n";
		...
		function CreateHtml_PRODSHOW_BRANCH($_date){
			...
			for($i = 1; $i <= 5; $i++){
				...
				if($$NowData != "" || ($i == 1 && $Data1 == "" && $Data2 == "" && $Data3 == "" && $Data4 == "" && $Data5 == "")){
					...
					if( ${$NowData}['pid1'] )
						echo("$<strong class=\"price_num\"><a href=\"pro_info.php?id=".${$NowData}['pid1']."&sid=".$this->shopid."\">".number_format($ProdData1['price'])."</a></strong><span class=\"slogan_buynow\"><a href=\"pro_info.php?id=".${$NowData}['pid1']."\">搶購</a></span>");
					...
					if( ${$NowData}['pid2'] )
						echo("$<strong class=\"price_num\"><a href=\"pro_info.php?id=".${$NowData}['pid2']."&sid=".$this->shopid."\">".number_format($ProdData2['price'])."</a></strong><span class=\"slogan_buynow\"><a href=\"pro_info.php?id=".${$NowData}['pid2']."\">搶購</a></span>");
					...
					if( ${$NowData}['pid3'] )
						echo("$<strong class=\"price_num\"><a href=\"pro_info.php?id=".${$NowData}['pid3']."&sid=".$this->shopid."\">".number_format($ProdData3['price'])."</a></strong><span class=\"slogan_buynow\"><a href=\"pro_info.php?id=".${$NowData}['pid3']."\">搶購</a></span>");
					...
					if( ${$NowData}['pid4'] )
						echo("$<strong class=\"price_num\"><a href=\"pro_info.php?id=".${$NowData}['pid4']."&sid=".$this->shopid."\">".number_format($ProdData4['price'])."</a></strong><span class=\"slogan_buynow\"><a href=\"pro_info.php?id=".${$NowData}['pid4']."\">搶購</a></span>");
					...
					if( ${$NowData}['pid5'] )
						echo("$<strong class=\"price_num\"><a href=\"pro_info.php?id=".${$NowData}['pid5']."&sid=".$this->shopid."\">".number_format($ProdData5['price'])."</a></strong><span class=\"slogan_buynow\"><a href=\"pro_info.php?id=".${$NowData}['pid5']."\">搶購</a></span>");
		...
		function CreateHtml_ChildClass_BRANCH($_date){
			...
			if( $ProductList[0]['serno'] )
				echo("特價$<strong class=\"price_num\"><a href=\"pro_info.php?id=".$ProductList[0]['serno']."&sid=".$this->shopid."\">".number_format($ProductList[0]['price'])."</a></strong><span class=\"slogan_buynow\"><a href=\"pro_info.php?id=".$ProductList[0]['serno']."\">搶購</a></span>");
			...
			if( $ProductList[1]['serno'] )
				echo("特價$<strong class=\"price_num\"><a href=\"pro_info.php?id=".$ProductList[1]['serno']."&sid=".$this->shopid."\">".number_format($ProductList[1]['price'])."</a></strong><span class=\"slogan_buynow\"><a href=\"pro_info.php?id=".$ProductList[1]['serno']."\">搶購</a></span>");
			...
			if( $ProductList[2]['serno'] )
				echo("特價$<strong class=\"price_num\"><a href=\"pro_info.php?id=".$ProductList[2]['serno']."&sid=".$this->shopid."\">".number_format($ProductList[2]['price'])."</a></strong><span class=\"slogan_buynow\"><a href=\"pro_info.php?id=".$ProductList[2]['serno']."\">搶購</a></span>");
			...
			if( $ProductList[3]['serno'] )
				echo("特價$<strong class=\"price_num\"><a href=\"pro_info.php?id=".$ProductList[3]['serno']."&sid=".$this->shopid."\">".number_format($ProductList[3]['price'])."</a></strong><span class=\"slogan_buynow\"><a href=\"pro_info.php?id=".$ProductList[3]['serno']."\">搶購</a></span>");
			...
			for($mno = 0; $mno < sizeof($MainClassData); $mno++){
				...
				for($i = 1; $i <= 5; $i++){
					...
					if($$NowData != "" || ($i == 1 && $Data1 == "" && $Data2 == "" && $Data3 == "" && $Data4 == "" && $Data5 == "")){
						...
						if( ${$NowData}['pid1'] )
							echo "$<strong class=\"price_num\"><a href=\"pro_info.php?id=".${$NowData}['pid1']."\">".number_format($ProdData1['price'])."</a></strong><span class=\"slogan_buynow\"><a href=\"pro_info.php?id=".${$NowData}['pid1']."\">搶購</a></span>";
						...
						if( ${$NowData}['pid2'] )
							echo "$<strong class=\"price_num\"><a href=\"pro_info.php?id=".${$NowData}['pid2']."\">".number_format($ProdData2['price'])."</a></strong><span class=\"slogan_buynow\"><a href=\"pro_info.php?id=".${$NowData}['pid2']."\">搶購</a></span>";
						...
						if( ${$NowData}['pid3'] )
							echo "$<strong class=\"price_num\"><a href=\"pro_info.php?id=".${$NowData}['pid3']."\">".number_format($ProdData3['price'])."</a></strong><span class=\"slogan_buynow\"><a href=\"pro_info.php?id=".${$NowData}['pid3']."\">搶購</a></span>";
						...
						if( ${$NowData}['pid4'] )
							echo "$<strong class=\"price_num\"><a href=\"pro_info.php?id=".${$NowData}['pid4']."\">".number_format($ProdData4['price'])."</a></strong><span class=\"slogan_buynow\"><a href=\"pro_info.php?id=".${$NowData}['pid4']."\">搶購</a></span>";
						...
						if( ${$NowData}['pid5'] )
							echo "$<strong class=\"price_num\"><a href=\"pro_info.php?id=".${$NowData}['pid5']."\">".number_format($ProdData5['price'])."</a></strong><span class=\"slogan_buynow\"><a href=\"pro_info.php?id=".${$NowData}['pid5']."\">搶購</a></span>";
