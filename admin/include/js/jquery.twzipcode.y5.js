...
;(function ($, window, document, undefined) {
    ...
    TWzipcode.prototype = {
        ...
        /**
         * custom - ajax get data
         */
        ajaxData: function (role) {
            var self = this,
                opts = self.options;

            try {
                $.getJSON(opts.ajaxData, '', function(json, textStatus) {
                    data = json;
                ...
                console.log('Ajax error, use default data.');
            };
         ...
         * @this {TWzipcode}
         *
         * custom - if ajaxData isset, get json date from that url.
         */
        init: function () {
            ...
            // custom ajax
            var last_init = '' !== opts.ajaxData ? self.ajaxData(role) : function(){
                self.role = role;
                // Reset the elements
                self.reset();
                // Elements events binding
